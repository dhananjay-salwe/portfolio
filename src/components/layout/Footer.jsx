      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex items-center space-x-1">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className="p-3 text-[var(--text)] hover:text-[var(--accent)] hover:bg-[var(--social-bg)] rounded-lg transition-all duration-200"
            ...
            <nav className="space-y-2">
              {quickLinks.map((link) => (
                <a
                  key={link.name}
                  href={link.href}
                  className="block text-[var(--text)] hover:text-[var(--accent)] transition-colors duration-200 text-sm"
                >
                  {link.name}
                </a>
              ))}
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-lg font-semibold text-[var(--text-h)]">Let's Connect</h3>
